...
2018.12.26
	移植到老板子，因flash限制，无法实现IAP功能
	灯光，按键功能正常
2018.12.27
	解决搜索服务器时不能解析服务器地址的bug
	降低发送搜索服务器命令的频率
	解决因为唤醒了没经初始化的线程导致的内存变量意外清零的bug
	-----------
	启用了iot任务
	用模拟收到了无线消息的方式，系统运行正常
	更改了发送温湿度更新消息的位置，测试数据上传正常

	获取服务器端口号：{"cmd":"serverconf","data":{"serverport":5555}}
2018.12.28
	采集器数据可以用来判断环境值超标
	解决任务挂起后不能恢复的问题
2019.1.16
	改正温控json协议错误的bug
2019.1.17
	增加data条目检测，上位机数据没有data条目时返回“NoneDataItem”
	上位机设置环境上下限是字符型，在这里转换为整形
2019.2.28
	解决给上位机返回没有降状态的bug 
